...
### senior-arquitecto-rioplatense-mentor-a-tdd-patrones-y-arquitectura
- Path: /home/nachosag/.config/opencode/skills/senior-arquitecto-rioplatense-mentor-a-tdd-patrones-y-arquitectura/SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
